    ...
    return (
        <div className="flex flex-col flex-1 w-full">
            ...
            <div className="flex flex-1 flex-col gap-4 p-4">
                ...
                <p className="text-gray-600">Aqui você pode visualizar todas as suas consultas finalizadas.</p>
                <Button onClick={() => window.location.href = '/marcar-consulta'} className="mt-4 w-min">Marcar Nova Consulta</Button>
                <ConsultList consultations={consults} patients={[]} includeStatus={["Finalizada"]} />
            </div>
        </div>
    );
}